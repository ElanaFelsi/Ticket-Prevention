...
///////////////////////////////////////////////////////////////////////////////////////////////////
std::string getLicensePlate(cv::Mat& LpCrop)
{
    ...
    /*imgOriginalScene = cv::imread("70-558-53.jpg");         // open image
...
void writeLicensePlateCharsOnImage(cv::Mat &imgOriginalScene, PossiblePlate &licPlate) {
    ...
    int intFontFace = cv::HersheyFonts::FONT_HERSHEY_SIMPLEX;                              // choose a plain jane font
    ...
    std::cout << licPlate.strChars << std::endl;
}
